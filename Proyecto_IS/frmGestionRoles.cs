...
namespace Proyecto_IS
{
    public partial class frmGestionRoles : Form, IidiomaObserver
    {
        ...
        // Evento: Al seleccionar una familia del combo, la cargamos para editar (Punto 1.3)
        private void cmbFamiliasExistentes_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void btnCrearPerfil_Click(object sender, EventArgs e) // Asegurate de vincular este evento al botón "➕ Crear" en el diseñador
        {
